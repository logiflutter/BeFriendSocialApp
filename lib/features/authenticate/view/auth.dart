...
import 'package:be_friend/features/authenticate/providers/is_login_provider.dart';
...
class _AuthScreenState extends ConsumerState<AuthScreen> {
  ...
  void didChangeDependencies() {
    userInfo = ref.watch(authProvider);
  ...
  Widget build(BuildContext context) {
    ...
    final bool isLoader = ref.watch(globalLoaderProvider);
                  ...
                  AppControlSlideTrandision(
                    AppElevatedButton(
                        onTap: () {
                          ...
                          isLogin
                              ? AuthController(ref: ref).handelSignIn()
                              : AuthController(ref: ref).handelSignUp();
                        },
